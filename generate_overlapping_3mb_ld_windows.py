...
ukbb_sumstats_hg19_dir = sys.argv[1]
overlapping_windows_file = sys.argv[2]
...
long_ld_regions = ['chr6_25500000_33500000', 'chr8_8000000_12000000', 'chr11_46000000_57000000']
...
sumstats_file = ukbb_sumstats_hg19_dir + 'biochemistry_Cholesterol_hg19_sumstats_sldsc_snp_filtered.txt'
...
t = open(overlapping_windows_file, 'w')
...
print(overlapping_windows_file)
